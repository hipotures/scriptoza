...
Collection of useful scripts organized by category.
...
- Log: `<input_directory>_out/compression.log`
...
**Typical compression:** 94-95% space savings while maintaining good quality (CQ45).
